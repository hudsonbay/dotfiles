...
# bar {
#   status_command exec /home/hudsonbay/.i3/i3status/mybar.sh
# }
...
myip_public() {
  ...
  echo -n "\"full_text\":\" $(/home/hudsonbay/.i3/i3status/ip.py) \","
...
disk_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/hudsonbay/.i3/i3status/disk.py)%\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "}"
}
...
memory() {
  ...
  echo -n "\"full_text\":\"  $(/home/hudsonbay/.i3/i3status/memory.py)%\","
...
cpu_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/hudsonbay/.i3/i3status/cpu.py)% \","
  echo -n "\"background\":\"#3949AB\","
  common
  echo -n "},"
}
...
meteo() {
  ...
  echo -n "\"full_text\":\" $(/home/hudsonbay/.i3/i3status/meteo.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
do
  ...
  if [[ $line == *"name"*"id_systemupdate"* ]]; then
    alacritty -e /home/hudsonbay/.i3/i3status/click_checkupdates.sh &
  ...
  # TIME
    ...
    alacritty -e /home/hudsonbay/.i3/i3status/click_time.sh &
